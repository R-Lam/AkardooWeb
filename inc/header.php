  ...
  <div class="navbar-fixed">
    ...
    <ul id="slide-out" class="side-nav grey lighten-4 txt-nav-menu">
      ...
      <li><a class="subheader subheader-txt">Navegación</a></li>
        <li class="opciones-nav"><a href="/public/articulos.php"><i class="material-icons">art_track</i>Articulos</a></li>
        <li class="opciones-nav"><a href="/public/articulos.php"><i class="material-icons">new_releases</i>Nuevos articulos</a></li>
        <li class="opciones-nav"><a href="/public/articulos.php"><i class="material-icons">trending_up</i>Lo mas popular</a></li>
      <!-- -->
      <li><div class="divider"></div></li>
      <li><a class="subheader subheader-txt">Nosotros</a></li>
        ...
        <li class="opciones-nav"><a href="/public/faq.php"><i class="material-icons">question_answer</i>Pregúntas frecuentes</a></li>
